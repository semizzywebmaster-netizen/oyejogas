...
| 15 | Admin, staff, customer, settings management | Admin for customers, staff, drivers, managers, roles, permissions, products, categories, orders, refills, pickups, deliveries, inventory, coupons, website/payment/notification settings, toggles, add-ons | 🟡 In progress | ☐ |
