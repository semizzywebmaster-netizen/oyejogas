...
| 17 | Payments, invoices, refunds, reconciliation | COD, transfer, gateway support, verification, statuses, references, invoices, receipts, refunds (partial/wallet), driver cash reconciliation, finance reports, failed payments; credentials outside public files | 🟡 In progress | ☐ |
