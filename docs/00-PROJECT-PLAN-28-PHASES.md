...
| 16 | Drivers, delivery, dispatch, logistics | Driver accounts/dashboard/availability, assignments, zones, fees, slots, dispatch board, notes, instructions, status, failed delivery, POD, cash collection, performance, logistics reports | 🟡 In progress | ☐ |
