...
| 20 | Spin-to-win campaigns and rewards | Campaigns, prizes, reward types/limits, dates, eligibility, one-spin-per-period, min-order, history, admin controls, expiry, manual reversal; secure server-side random | 🟡 In progress | ☐ |
