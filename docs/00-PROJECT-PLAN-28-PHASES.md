...
| 12 | Gas refill management | Refill form, size/qty, cylinder details, pickup-or-delivery, pricing, status flow, assignment, processing, completion, history, notifications | 🟡 In progress | ☐ |
