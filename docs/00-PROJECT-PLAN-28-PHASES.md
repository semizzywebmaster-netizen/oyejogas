...
| 13 | Cylinder pickup, return, exchange | Pickup requests, empty collection, exchange, condition, serials, customer- vs company-owned tracking, damage, deposits, scheduling, confirmation, returns, history | 🟢 Approved — see `docs/13-Phase-13-Verification-Report.md` | ☑ |
| 14 | Inventory and cylinder tracking | Full/empty/awaiting-refill/damaged stock, serials, accessories, adjustments, transfers, deductions, additions, low-stock alerts, movements, suppliers, purchases, reports | 🟢 Approved — see `docs/14-Phase-14-Verification-Report.md` | ☑ |
| 15 | Admin, staff, customer, settings management | Admin for customers, staff, drivers, managers, roles, permissions, products, categories, orders, refills, pickups, deliveries, inventory, coupons, website/payment/notification settings, toggles, add-ons | 🟢 Approved — see `docs/15-Phase-15-Verification-Report.md` | ☑ |
| 16 | Drivers, delivery, dispatch, logistics | Driver accounts/dashboard/availability, assignments, zones, fees, slots, dispatch board, notes, instructions, status, failed delivery, POD, cash collection, performance, logistics reports | 🟢 Approved — see `docs/16-Phase-16-Verification-Report.md` | ☑ |
| 17 | Payments, invoices, refunds, reconciliation | COD, transfer, gateway support, verification, statuses, references, invoices, receipts, refunds (partial/wallet), driver cash reconciliation, finance reports, failed payments; credentials outside public files | 🟢 Approved — see `docs/17-Phase-17-Verification-Report.md` | ☑ |
| 18 | Support tickets, reviews, complaints, contact | Contact form, tickets (categories/priorities/statuses), customer/staff replies, internal notes, complaints, refund requests, product/delivery reviews, ratings, reports | 🟢 Approved — see `docs/18-Phase-18-Verification-Report.md` | ☑ |
| 19 | Marketing, CMS, banners, FAQs, announcements | Banners, campaigns, coupons, discount codes, featured products, FAQs, announcements, blog updates, editable homepage, newsletter, marketing reports, publishing controls | 🟢 Approved — see `docs/19-Phase-19-Verification-Report.md` | ☑ |
| 20 | Spin-to-win campaigns and rewards | Campaigns, prizes, reward types/limits, dates, eligibility, one-spin-per-period, min-order, history, admin controls, expiry, manual reversal; secure server-side random | 🟢 Approved — see `docs/20-Phase-20-Verification-Report.md` | ☑ |
| 21 | Referral codes, rewards, anti-fraud | Codes, links, tracking, qualification, referrer/referred rewards, history, expiry, min purchase, self-referral prevention, duplicate detection, suspicious flags, admin mgmt | 🟢 Approved — see `docs/21-Phase-21-Verification-Report.md` | ☑ |
...
| 26 | Add-on and future-feature architecture | Registration, versioning, settings, permissions, menus, migrations, toggles, dependencies, install/update status, logs, enable/disable; 11 future add-ons specified | 🟢 Done (2026-09-11, E2E 43/43, checker 434/434) | ☑ |
